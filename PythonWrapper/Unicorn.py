...
def GetAvailableDevices(rescan:bool)-> tuple[list[str], UnicornReturnStatus]:
    ...
    output = UnicornReturnStatus(unicorn.lib.UNICORN_GetAvailableDevices(None, ctypes.byref(DeviceCount), rescanInt))
    print(output)
...
def StartAcquisition(handle:int, testSignalEnabled:bool)->UnicornReturnStatus:
    ...
    return UnicornReturnStatus(unicorn.lib.UNICORN_StartAcquisition(handle, testSignalEnabledInt))
